...
#
# Description:
# This is the completely redesigned, bias-free backtester for higher timeframes,
# built on the "Scout and Sniper" principle. It is fully aligned with all
# the advanced, toggleable features of the V8 daily hybrid backtester.
