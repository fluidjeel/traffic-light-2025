...
# It incorporates algorithmic improvements to run significantly faster by
# reducing redundant calculations within the main intraday loop.
...
def run_backtest(cfg):
    ...
    for date in master_dates:
        ...
        if not today_intraday_candles.empty and watchlist:
            # OPTIMIZATION: Pre-calculate cumulative volumes for the day for all watchlist stocks
                ...
                for symbol, details in list(watchlist.items()):
                    ...
                    if details['status'] == 'triggered':
                        ...
                        if cfg['volume_velocity_filter']:
                            # OPTIMIZATION: Use pre-calculated cumulative volume and average volume
